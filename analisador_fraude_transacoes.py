...
def analisar_transacao(lista_de_transacoes):
    ...
    resposta = cliente.generate_content(f"Considere o CSV abaixo, onde cada linha é uma transação diferente: {lista_de_transacoes}. Sua resposta deve adotar o #Formato de Resposta (apenas um json sem outros comentários)")
